package com.me.guanpj.jhttp.upload;
...
//			post content
     ...
     * @param entities
     */
    public static void upload(OutputStream out, String postContent, ArrayList<FileEntity> entities, OnProgressUpdateListener listener) throws AppException {
        String BOUNDARY = "7d4a6d158c9"; // 数据分隔线
        String PREFIX = "--", LINEND = "\r\n";
        String CHARSET = "UTF-8";
        DataOutputStream outStream = new DataOutputStream(out);
